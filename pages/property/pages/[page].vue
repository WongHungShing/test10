					  ...
					  <div class='col-md-12 text-center'>
					  	...
					  	<div class='row'>
						  	<div class='col-md-4 text-left'>
							  	<div v-for ='property in properties' class='outer'>
								  	<a href='single.html'>
									  	<div class='upper'>
        ...
        <div class="row text-center thepage">
                       ...
                       <nav aria-label="Page navigation example">
                           ...
                           <li class="page-item" v-if="page > 1">
                               ...
                               <a :href="'/property/pages/' + prevpage" class="page-link">
                           ...
                           <li class="display@sm pagination__item_wrapper page-link"
                               ...
                               <a :href="'/property/pages/' + pageNumber">{{ pageNumber }}</a>
                           ...
                           <li class="page-item" v-if="page < totalPages">
                               ...
                               <a :href="'/property/pages/' + nextpage" class="page-link">
...
const runtimeConfig = useRuntimeConfig();
    ...
    if (data.value){properties.value = data.value.properties;};
